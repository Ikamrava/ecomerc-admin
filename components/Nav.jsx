...
function Nav() {
    const activelink = "cursor-pointer flex gap-2 items-center"
    const inactivelink = "cursor-pointer flex gap-2 items-center opacity-50"
    const router = useRouter()
    const {pathname} = router
  return (
    <aside >
        <nav className='flex gap-5 flex-col bg-slate-800  h-[90vh] pt-3 rounded-lg px-4 text-white font-bold'>
            ...
            <Link href={"/"} >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                 ...
                 <p className='md:block hidden'>Dashbord</p>
            ...
            <Link href={"/categories"} >
                ...
                <p className='md:block hidden'>Categories</p>
                </div>
