...
function products() {
  ...
  return (
    <Layout>
      ...
      <table className='table-auto max-w-lg mt-5'>
        <thead>
          ...
          <tbody>
            ...
            <tr key={product._id} className='  rounded-lg border-2 border-slate-400 '>
              ...
              <td className=' flex justify-between ml-2  font-bold first-letter:capitalize border-2 gap-2'>

                  <Link href={`/products/edit/${product._id}`}>
                    <div className=' flex bg-slate-600 relative rounded-xl px-2 items-center gap-1 '>
                                ...
                                <button className='btn btn-primary  py-1 rounded-lg text-white font-bold text-right  '>Edit</button>
                    </div>
                  
                  </Link>
                  <Link href={`/products/delete/${product._id}`}>
                    <div className='  bg-red-600 flex relative rounded-xl px-2 items-center gap-1'>
                                ...
                                <button className='btn btn-primary  py-1 rounded-lg text-white font-bold text-right   '>Delete</button>
